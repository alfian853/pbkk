        ...
        <div class="panel panel-info text-center">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <a href="/mhs" class="btn btn-primary">
                <i class="fa fa-user"></i> DATA MAHASISWA</a></li>
            </ul>
        </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        <div class="panel panel-info text-center">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><a href="/matkul" class="btn btn-primary"><i class="fa fa-university"></i> DATA MATKUL</a></li>
            </ul>
        </div>
    </div>
    <div class="col-md-2">
